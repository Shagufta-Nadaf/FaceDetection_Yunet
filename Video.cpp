...
int main(int argc, char** argv)
{
    CommandLineParser parser(argc, argv,
        ...
        "{video v           | /home/itstarkenn/Downloads/VID_337361108_114019_366.mp4          | Path to the input video}"
        "{scale sc          | 1.0        | Scale factor used to resize input video frames}"
        "{fd_model fd       | /home/itstarkenn/Downloads/face_detection_yunet_2023mar.onnx| Path to the model. Download yunet.onnx in https://github.com/opencv/opencv_zoo/tree/master/models/face_detection_yunet}"
